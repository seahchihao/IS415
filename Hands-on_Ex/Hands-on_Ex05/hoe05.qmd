...
Compute spatial weights using R by :
...
Bring a geospatial data and its associated attribute table into R environment. The geospatial data is in ESRI shapefile format and the attribute table is in csv fomat.
...
## 4.0 Visualising Regional Development Indicator
...
## 5.0 Computing Contiguity Spatial Weights
