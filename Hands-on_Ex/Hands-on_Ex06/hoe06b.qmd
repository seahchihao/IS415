...
Compute Local Measures of Spatial Autocorrelation (LMSA) by using **spdep** package. By the end to this hands-on exercise, you will be able to:
...
## 4.0 Local Indicators of Spatial Association(LISA)
...
## 5.0 Creating a LISA Cluster Map
