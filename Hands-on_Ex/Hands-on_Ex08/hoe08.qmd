...
## 1.0 Context
This will be a continuation of [Hands-On Ex07](https://is415-chihao-journey.netlify.app/hands-on_ex/hands-on_ex07/hoe07).
...
### 2.4 Computing minimum spanning tree
...
### 2.6 Visualising the clusters in choropleth map
...
## 3.0 Spatially Constrained Clustering: ClustGeo Method
